...
const AdminProjectDetailScreen = ({ route, navigation }) => {
  ...
  const handleTaskPress = (task) => {
    navigation.navigate('AdminTaskDetail', { 
      taskId: task.id,
      projectId: projectId
    });
  };
  ...
  const renderOverview = () => {
    ...
    return (
      ...
      >
        {/* Project Stats Grid */}
        <View className={`flex-row flex-wrap justify-between mb-6 ${isTablet ? 'space-x-2' : ''}`}>
          <View 
            className={`${isTablet ? 'flex-1 mx-1' : cardWidth} bg-white rounded-3xl p-5 mb-4 shadow-2xl border border-gray-100 hover:shadow-3xl hover:border-purple-200 transition-all duration-300`}
            style={isTablet ? { minWidth: '23%' } : {}}
          >
            ...
            <Text className="text-sm font-semibold text-gray-600">Total Tasks</Text>
          </View>

          <View 
            className={`${isTablet ? 'flex-1 mx-1' : cardWidth} bg-white rounded-3xl p-5 mb-4 shadow-2xl border border-gray-100 hover:shadow-3xl hover:border-green-200 transition-all duration-300`}
            style={isTablet ? { minWidth: '23%' } : {}}
          >
            ...
            <Text className="text-2xl font-bold text-gray-800 mb-1">{stats.completed}</Text>
            <Text className="text-sm font-semibold text-gray-600">Completed</Text>
          </View>

          <View 
            className={`${isTablet ? 'flex-1 mx-1' : cardWidth} bg-white rounded-3xl p-5 mb-4 shadow-2xl border border-gray-100 hover:shadow-3xl hover:border-blue-200 transition-all duration-300`}
            style={isTablet ? { minWidth: '23%' } : {}}
          >
            ...
            <Text className="text-2xl font-bold text-gray-800 mb-1">{stats.inProgress}</Text>
            <Text className="text-sm font-semibold text-gray-600">In Progress</Text>
          </View>

          <View 
            className={`${isTablet ? 'flex-1 mx-1' : cardWidth} bg-white rounded-3xl p-5 mb-4 shadow-2xl border border-gray-100 hover:shadow-3xl hover:border-red-200 transition-all duration-300`}
            style={isTablet ? { minWidth: '23%' } : {}}
          >
            <View className="w-12 h-12 rounded-2xl bg-red-100 items-center justify-center mb-3">
              <Ionicons name="alert-circle-outline" size={24} color="#ef4444" />
            </View>
            <Text className="text-2xl font-bold text-gray-800 mb-1">{stats.todo}</Text>
            <Text className="text-sm font-semibold text-gray-600">To Do</Text>
          </View>
        </View>
            ...
            <View className="flex-row items-center p-4 rounded-2xl bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
              ...
              <View className="flex-1">
                ...
                <Text className="text-sm text-gray-500 mt-1">
                  {project?.manager?.email || 'Add a project manager'}
                </Text>
              </View>
    ...
    >
        ...
        <View className="px-6">
          <View className="flex-row items-center justify-between mb-4">
            ...
            <View className="flex-1 mx-4" style={{ maxWidth: width * 0.6 }}>
              ...
              <Text 
                className="text-purple-100 text-sm text-center truncate"
                numberOfLines={1}
              >
                {project?.deskripsi || 'Project details and management'}
              </Text>
            </View>
          ...
          <View className="flex-row justify-center mt-2">
            <View className="flex-row items-center bg-white/20 px-4 py-2 rounded-full backdrop-blur-sm">
              ...
              <Text className="text-white text-sm font-bold">Active Project</Text>
      ...
      >
        <View className="px-6 pt-2">
          <View className="bg-white rounded-2xl px-4 py-3 shadow-2xl border border-purple-200">
            <View className="flex-row items-center">
            ...
            {['overview', 'members', 'tasks'].map((tab) => (
              <TouchableOpacity
                ...
                className={`flex-1 flex-row items-center justify-center py-4 rounded-xl ${
                  activeTab === tab ? 'bg-gradient-to-r from-purple-50 to-blue-50' : ''
                } active:opacity-80`}
              ...
              >
                <View className="relative">
                  ...
                  />
                  {activeTab === tab && (
                    <View className="absolute -bottom-1 left-1/2 w-1 h-1 bg-purple-500 rounded-full -translate-x-1/2" />
                  )}
                </View>
              ...
              <FlatList
                ...
                ListEmptyComponent={
                  <View className="items-center justify-center py-20 px-8 min-h-[400px]">
                    <View className="w-40 h-40 rounded-full bg-gradient-to-r from-purple-100 to-blue-100 items-center justify-center mb-6 border-4 border-white shadow-2xl">
                      <Ionicons 
                    ...
                    {searchQuery && (
                      <TouchableOpacity 
                        className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl px-8 py-4 mt-8 shadow-lg active:scale-95"
                        onPress={() => setSearchQuery('')}
                      >
...
export default AdminProjectDetailScreen;